...
```json
{
  ...
  "description": "pow pow",
  "logo": "https://remilio.org/remilio/3760.png",
  "twitter": "https://twitter.com/redbottomdancer"
}
```

Paste this in a public place (github).

`nano operator.yaml`

1. Get raw url to the metadata.json, paste as "metadata_url"
2. EL_Slasher_Address: 0xD11d60b669Ecf7bE10329726043B3ac07B380C22
3. BLS Compendium Address: 0xc81d3963087Fe09316cd1E032457989C7aC91b19
