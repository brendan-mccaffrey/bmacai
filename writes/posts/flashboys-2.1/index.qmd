...
In the Spring of 2021, I worked as an intern for an active, multi-strategy New York family office. Within the first month of my internship, I discovered [MEV in blockchain networks](../../../library/natural-sciences/crypto/blockchain/chains/ethereum/mev/index.qmd). For the next few months, I pursued "searching" (the act of axtracting MEV): learning the Solidity and Golang programming languages from scratch, familiarizing myself with the Ethereum Virutal Machine, and developing infrastructure to automate on-chain arbitrage monitoring, and execution.
